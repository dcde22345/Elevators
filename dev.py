...
if __name__ == "__main__":
    ...
    def run_elevator_simulation(data, sim_pace=None, manager=Look, limitations=None, seed=1):
    ...
    run_elevator_simulation(data_60_at_six_floor, sim_pace=None, manager=Look, limitations=limitations, seed=1)
    # run_elevator_simulation(data_120_at_six_floor, sim_pace=None, manager=Look, limitations=limitations, seed=1)
    # run_elevator_simulation(data_180_at_six_floor, sim_pace=None, manager=Look, limitations=limitations, seed=1)
    # run_elevator_simulation(data, sim_pace=None, manager=Look, limitations=limitations, seed=1)
    # run_elevator_simulation(new_data, sim_pace=None, manager=Look, limitations=None, seed=1)